...
export function renderHTML(body, pLink, pIdx) {
  ...
  <html lang="en">
    ...
    <body>
      <nav id="navbar" data-turbolinks-permanent><div class="brand">📁 大液泡的网盘</div></nav>
      ${body}
      <div class="paginate-container">${pagination(pIdx)}</div>
      <div id="flex-container" data-turbolinks-permanent style="flex-grow: 1;"></div>
      <footer id="footer" data-turbolinks-permanent><p>Powered by <a href="https://github.com/spencerwooo/onedrive-cf-index">onedrive-cf-index</a>, hosted on <a href="https://workers.cloudflare.com/">Cloudflare Workers</a>.</p></footer>
      <script>
